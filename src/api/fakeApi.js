...
import { getManagementStage as deriveManagementStage } from "../utils/managementStage";
import { createOperationResult } from "./apiTypes";
...
export async function createIssueDraft(data) {
  try {
    ...
    try {
      ...
      return createOperationResult(true, payload);
    } catch (e) {
      console.error("createIssueDraft failed", e);
      return createOperationResult(false, null, e?.message || String(e));
    }
  }
}
