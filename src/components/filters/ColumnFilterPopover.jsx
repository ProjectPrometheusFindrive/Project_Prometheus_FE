...
export default function ColumnFilterPopover({
  ...
  useEffect(() => {
    ...
    if (column?.filterTriState === false && (boolVal === null || typeof boolVal === 'undefined'))
      return;
  ...
  const [op, setOp] = useState(() =>
    column?.filterAllowAnd === false ? 'OR' : value?.op || column?.filterOp || 'OR'
  );
  ...
  return (
    ...
    >
      <div className="filter-popover__content">
        {(isManagementStageFilter || isContractStatusFilter || isCompanyFilter) &&
