                                        ...
                                        >
                                            <span className="sort-icon" aria-hidden="true">
                                                {sortKey === col.key && sortDir === "asc" ? (
                                                    <div data-svg-wrapper data-layer="Polygon 1" className="Polygon1">
                                                        <svg width="10" height="6" viewBox="0 0 10 6" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                            <path d="M4.40319 0.246142C4.69193 -0.0820475 5.30807 -0.082047 5.59681 0.246143L9.8695 5.10264C10.2031 5.48183 9.85849 6 9.2727 6H0.727302C0.141512 6 -0.20311 5.48183 0.130495 5.10264L4.40319 0.246142Z" fill="#1C1C1C"/>
                                                        </svg>
                                                    </div>
                                                ) : sortKey === col.key && sortDir === "desc" ? (
                                                    <div data-svg-wrapper data-layer="Polygon 1" className="Polygon1">
                                                        <svg width="10" height="6" viewBox="0 0 10 6" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                            <path d="M4.40319 5.75386C4.69193 6.08205 5.30807 6.08205 5.59681 5.75386L9.8695 0.897362C10.2031 0.518175 9.85849 0 9.2727 0H0.727302C0.141512 0 -0.20311 0.518175 0.130495 0.897362L4.40319 5.75386Z" fill="#1C1C1C"/>
                                                        </svg>
                                                    </div>
                                                ) : (
                                                    <div data-svg-wrapper data-layer="Polygon 1" className="Polygon1">
                                                        <svg width="10" height="6" viewBox="0 0 10 6" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                            <path d="M4.40319 5.75386C4.69193 6.08205 5.30807 6.08205 5.59681 5.75386L9.8695 0.897361C10.2031 0.518174 9.85849 0 9.2727 0H0.727302C0.141512 0 -0.20311 0.518175 0.130495 0.897362L4.40319 5.75386Z" fill="#B7BABC"/>
                                                        </svg>
                                                    </div>
                                                )}
                                            </span>
